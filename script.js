function getWeather() {
    ...
    reqLoc.open("GET",`http://api.openweathermap.org/geo/1.0/direct?q=${location}&limit=1&appid=7ded80d91f2b280ec979100cc8bbba94&units=metric`,true)
    reqLoc.addEventListener("load", function(event) {
        ...
        reqCurr.open("GET",`https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&limit=5&appid=7ded80d91f2b280ec979100cc8bbba94&units=metric`,true);
        ...
        let reqFore = fetch(`https://api.openweathermap.org/data/2.5/forecast?lat=${lat}&lon=${lon}&appid=7ded80d91f2b280ec979100cc8bbba94&units=metric`)
            .then((response) => {
